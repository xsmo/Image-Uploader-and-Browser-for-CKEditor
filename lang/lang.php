<div id="setLangDiv" class="lightbox popout">
    ...
    <p class="uploadP" onclick="selectLang('fr');"><img src="img/cd-icon-polish.png" class="headerIcon"> Polish</p>
    <p class="uploadP" onclick="selectLang('pl');"><img src="img/cd-icon-french.png" class="headerIcon"> Français</p>
    <br>
